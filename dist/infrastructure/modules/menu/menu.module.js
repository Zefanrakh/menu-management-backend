...
const menu_repository_impl_1 = require("./repositories/menu.repository.impl");
...
exports.MenuModule = MenuModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: menu_repository_1.MenuRepository,
                useClass: menu_repository_impl_1.MenuRepositoryImpl,
            },
        ],
